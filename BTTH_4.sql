DROP DATABASE IF EXISTS BTTH4;
CREATE DATABASE BTTH4;
USE BTTH4;
...
VALUES
	...
	('Student 2', '2004-02-02', 'Female'),
	('Student 3', '2005-03-03', 'Male'),
	('Student 4', '2006-04-04', 'Female'), 
	('Student 5', '2002-05-05', 'Male'),
...
-- BTTH4:
SELECT s.full_name, s.date_of_birth, s.gender
FROM students s
...
WHERE c.course_name = 'English Communication'
AND e.score = (
    SELECT MAX(e2.score)
    FROM enrollments e2
    JOIN courses c2 ON e2.course_id = c2.id
    WHERE c2.course_name = 'English Communication'
);
